const ranSelectOp = ["//div[text()='Adriana Cruz de Jesus']",
...
for(let i = 0; i < ranSelectOp.length; i = i + 1 ) {
  
   var ranExpOne = ranSelectOp[i] 
       
}

export const randomlySelectOP = ranExpOne