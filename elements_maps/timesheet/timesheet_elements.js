...
export const additionalInformationLink = "//input[@type='checkbox']"
...
export const timeUpBtnSave = "//span[normalize-space()='Salvar']"

// TODO Timesheet Test Page Xpaths

export const timesheetOption = "//li[@role='menuitem']//span[contains(text(),'Horas')]"
export const successCreateTimesheet = "//div[@class='ant-message-custom-content ant-message-success']"
