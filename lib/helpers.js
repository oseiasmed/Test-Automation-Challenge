module.exports = {
    ...
    waitAndSelectFour: async function (page, selector, optionOne,optionTwo,optionThree) {
        try {
            await page.waitForXPath(selector)
            var selectInput = await page.$x(selector)
            await selectInput[0].click(selector)
            ...
            await page.waitForXPath(optionThree)
            var selectInputItemThree = await page.$x(optionThree)
            await selectInputItemThree[0].click(optionThree)
