...
const ranProgressTwo = ["//div[text()='Não definido']", "//div[text()='Audiência de Conciliação']",
    "//div[text()='Contestação'],//div[text()='Audiência de Instrução'],//div[text()='Solitação de Documento/Informação']",
    "//div[text()='Petição']"]
